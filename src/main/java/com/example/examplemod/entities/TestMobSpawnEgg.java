 ...
 */
public class TestMobSpawnEgg extends ItemMonsterPlacer{
    ...
    public TestMobSpawnEgg(int primaryColor, int secondaryColor) {
    ...
    public int getColorFromItemStack(ItemStack p_82790_1_, int p_82790_2_) {
        return p_82790_2_ == 0 ? primaryColor : secondaryColor;
    }

    @Override
    public String getItemStackDisplayName(ItemStack p_77653_1_) {
        String s = ("" + StatCollector.translateToLocal(this.getUnlocalizedName() + ".name")).trim();
        Class c = spawnableEntities[p_77653_1_.getItemDamage()];
        String s1 = EntityList.classToStringMapping.get(c).toString();
        if(s1 != null){
